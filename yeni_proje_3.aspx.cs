...
{
    public partial class yeni_proje_3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            divErrorCreditCard.Visible = false;
            ...
            DataTable TabloProjeBilgileri = Veritabani.Sorgu_DataTable("SELECT TOP(1) TipID, KuponKodu, Odul, HizmetBedeli, Ekstra, ToplamMaliyet FROM gp_Projeler WHERE ProjeID=@ProjeID", SeciliProjeID);
        ...
        protected void btnKrediKarti_Click(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(KrediKartNumara1, out IntDenemeTahtasi)) KrediKartNumara1 = "";
